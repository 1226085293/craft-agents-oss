...
const EXPECTED_CHANNELS: string[] = [
  ...
  "LLM_Connection:test",
  "LLM_Connection:toggleModel",
  "LLM_Connection:updateModelEnabled",
  ...
  "deeplink:navigate",
  "defense:getEnabled",
  "defense:getGuardrails",
  "defense:setEnabled",
  "defense:setGuardrails",
  "dialog:openFolder",
  "drafts:delete",
  "drafts:get",
  "drafts:getAll",
  ...
  "messaging:wechat:submitVerifyCode",
